...
Questa email è stata inviata automaticamente. Si prega di non rispondere.
      ...
      console.error('❌ [Complete Affiliation] Errore invio email di conferma:', {
        affiliationId,
    ...
    console.warn(
      `⚠️ [Complete Affiliation] Resend non configurato, email di conferma non inviata per affiliation ${affiliationId}`
    )
  } else if (updatedAffiliation.confirmationEmailSentAt) {
    console.log(
      `ℹ️ [Complete Affiliation] Email già inviata precedentemente per affiliation ${affiliationId}`
    )
  }
...
Questa email è stata inviata automaticamente. Si prega di non rispondere.
      ...
      console.error('❌ [Complete Affiliation] Errore invio tessera PDF:', {
        affiliationId,
    ...
    console.warn(
      `⚠️ [Complete Affiliation] Resend non configurato, tessera PDF non inviata per affiliation ${affiliationId}`
    )
  } else if (updatedAffiliation.membershipCardSentAt) {
    console.log(
      `ℹ️ [Complete Affiliation] Tessera già inviata precedentemente per affiliation ${affiliationId}`
    )
  } else if (!updatedAffiliation.memberNumber) {
    console.warn(
      `⚠️ [Complete Affiliation] memberNumber non disponibile, tessera PDF non inviata per affiliation ${affiliationId}`
    )
  }
