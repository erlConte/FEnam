...
// - Runtime (API routes) usa DATABASE_URL (Session pooler, porta 6543)
// - Migrazioni Prisma usano DIRECT_URL (Direct connection, porta 5432) se disponibile
// - Se DIRECT_URL non è raggiungibile (es. Vercel IPv4-only), usa SKIP_MIGRATIONS=true
// - Vedi DEPLOY_SUPABASE.md per dettagli completi
//
